{
TFile *f = new TFile("histo2017.root","RECREATE"); 
f->cd(); 
...
h24->SetFillColor(2);
h24->SetTitle("PPS Strip RPSiDetDigitizer vs totemRPRawToDigi - ExHuME 2017; totemRPRawToDigi strip_no_; RPSiDetDigitizer strip_no_");
...
h25->SetTitle("PPS Strip RPSiDetDigitizer vs totemRPRawToDigi / multiplicity cut - ExHuME 2017; totemRPRawToDigi strip_no_; RPSiDetDigitizer strip_no_"); 
...
h28->SetTitle("PPS Pixel RPixDetDigitizer vs ctppsPixelDigis - ExHuME 2017; ctppsPixelDigis theData ; RPixDetDigitizer theData");
...
//h26->SetLineColor(0);
h26->SetTitle("PPS Strip RPSiDetDigitizer and totemRPRawToDigi multiplicities ; Strip multiplicity");

Events->Draw("TotemRPDigiedmDetSetVector_totemRPRawToDigi_TrackingStrip_RECO.obj._sets.size()>>h27");
h27->SetLineColor(4); 
h27->SetTitle("PPS Strip RPSiDetDigitizer and totemRPRawToDigi multiplicities ; Strip multiplicity");
