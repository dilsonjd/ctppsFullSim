...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:GluGlu_GEN_SIM_2016.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('GluGlu_DIGI_DIGI2RAW_2016.root'),
...
from Configuration.StandardSequences.cmsCTPPSDigi_cff import *
ctpps_2016.toReplaceWith(pdigi, pdigi.copyAndExclude([RPixDetDigitizer]))
from Configuration.StandardSequences.cmsCTPPSDigiToRaw_cff import *
