...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:GluGlu_GEN_SIM_2018.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('GluGlu_DIGI_DIGI2RAW_2018.root'),
    outputCommands = process.FEVTDEBUGHLTEventContent.outputCommands+['keep *_RPixDetDigitizer_*_*','keep *_ctppsPixelRawData_*_*','keep CTPPS*_*_*_*'], 
