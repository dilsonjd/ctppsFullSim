...
process.load('Configuration.StandardSequences.ctppsReconstruction2017_cff')
...
#ctpps_2017.toReplaceWith(RawToDigi, RawToDigi.copyAndExclude([ctppsDiamondRawToDigi]))

# modify CTPPS 2017 raw-to-digi modules
#process.load("EventFilter.CTPPSRawToDigi.pgctppsRawToDigi2017_cfi")
